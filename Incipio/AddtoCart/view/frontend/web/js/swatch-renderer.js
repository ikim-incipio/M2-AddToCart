 ...
 * 2017-03 Isaac Kim
 * functions modified: _LoadProductMedia, _ProductMediaCallback
 * modified to allow swatch image update in product view lightbox
 */
define([
    'jquery',
    'underscore',
    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _LoadProductMedia: function () {
            ...
            if ($('body.catalog-product-view').size() > 0) {
                ...
                //Category View - Product AddtoCart LightBox
                if (!productId){
                    productId = $('.productViewLightBox').find('.price-box.price-final_price').attr('data-product-id');
                }
            }
        ...
        _ProductMediaCallback: function ($this, response) {
            var isProductViewExist = $('body.catalog-product-view').size() > 0 || $('.productViewLightBox').size() > 0,
            ...
            // if category page - product view light box
            if ($('.productViewLightBox').size() > 0){
                $main = $this.parents('.productViewLightBox');
            }
